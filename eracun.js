...
streznik.get('/', function(zahteva, odgovor) {
  if(zahteva.session.prijavljenaStranka == null) {
    ...
    form.parse(zahteva, function (napaka1, polja, datoteke) {
      strankaIzRacuna(polja.seznamRacunov, function(stranka){
        pesmiIzRacuna(polja.seznamRacunov, function(pesmi){
          ...
          odgovor.render('eslog', {vizualiziraj: true, postavkeRacuna: pesmi, podatkiStranke: stranka[0]})
...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    var uspesnaRegistracija = "Stranka je bila uspešno registrirana.";
    var prisloJeDoNapake = "Prišlo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in poskusite znova.";
    
     vrniStranke(function(napaka1, stranke){
       vrniRacune(function(napaka2, racuni) {
         
         if(napaka1 || napaka2){
             odgovor.render('prijava', {sporocilo: prisloJeDoNapake, seznamStrank: stranke, seznamRacunov: racuni});
         }else{
           odgovor.render('prijava', {sporocilo: uspesnaRegistracija, seznamStrank: stranke, seznamRacunov: racuni});
         }
       })
     });  
